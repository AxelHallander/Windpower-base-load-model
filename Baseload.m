...
clear years sinusoidalModel Regions regions region options numericDates ...
    minLoadByCountry array countryCodes countryMatrices FittedValues ...
    HourlyLoads i Loads loadValues
