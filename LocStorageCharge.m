function [loc_storage_matrix,over_capacity] = LocStorageCharge(loc_storage_matrix,loc_power_cap,loc_storage_cap,over_capacity,big_storage_efficiency,local_storage_efficiency,regional_efficiency,t)
...
% introduced. 
    ...
    for idx = sortedIndices'
        ...
        if over_capacity <= 0 
            break;
        elseif loc_storage_matrix(idx,t) >= loc_storage_cap(idx)
            break;
        else
